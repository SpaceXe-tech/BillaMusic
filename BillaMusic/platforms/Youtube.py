...
from BillaMusic.utils.formatters import time_to_seconds
...
class YouTubeAPI:
    ...
    async def playlist(self, link, limit, user_id, videoid: Union[bool, str] = None):
        ...
        playlist = await shell_cmd(
            f"yt-dlp -i --get-id --flat-playlist --playlist-end {limit} --skip-download --cookies youtube.txt {link}"
        )
        try:
    ...
    async def formats(self, link: str, videoid: Union[bool, str] = None):
        ...
        ydl_opts = {"quiet": True, "cookiefile": "youtube.txt"} 
