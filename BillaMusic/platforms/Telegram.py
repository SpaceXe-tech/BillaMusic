...
from BillaMusic.utils.formatters import (
    check_duration,
    convert_bytes,
    get_readable_time,
    seconds_to_min,
...
tg_1 = "<u><b>{} Space-X Downloader</b></u>\n\n<b>File Size:</b> {}\n<b>Completed:</b> {}\n<b>Percentage:</b> {}%\n\n<b>Speed:</b> {}/s\n<b>ETA:</b> {}"
        ...
        async def down_load():
            ...
            try:
                ...
                try:
                    ...
                    elapsed = "0 second"
                await mystic.edit_text(
                    "Succesfully Downloaded, Processing File...\n\n<b>Time Elapsed:</b> {0}".format(
                        elapsed
                    )
                )
            except BaseException:
                await mystic.edit_text(
                    "Failed to download media from telegram, please try again by Replying /play to media to RE-stream."
                )
